...
const Home = () => {
    ...
    >
      <div className="min-h-screen overflow-x-hidden">
        ...
        <div className="relative w-full ">
          <video
            className="w-full min-h-screen max-h-screen object-cover opacity-60"
            autoPlay
            muted
            loop
          >
          ...
          {/* <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/50">
            <span className="text-black text-3xl sm:text-6xl text-center font-sans drop-shadow-lg">
              "Delivering health solutions
              <br />
              for a better tomorrow."
            </span>
          </div> */}
          <div className="absolute inset-0  flex items-center flex-col justify-center bg-black/50 z-10 text-center max-w-5xl mx-auto px-4">
          <h1 className="text-2xl  shadow-lg lg:text-4xl font-sans font-bold bg-blue-50 p-5 rounded-lg rounded text-gray-800 mb-6 leading-tight">
            <span className="bg-gradient-to-r z-50 from-blue-600 to-blue-800 bg-clip-text text-transparent">
              Delivering Health Solutions
            </span>
            <br />
            <span className="text-gray-700">for a Better Tomorrow at</span>
          </h1>
          {/* <h1 className="ext-2xl lg:text-3xl font-sans font-bold  p-5 rounded-lg rounded text-gray-800 mb-6 leading-tight">At</h1> */}
          <h1 className="text-2xl  shadow-lg lg:text-6xl font-sans font-bold bg-blue-50 p-5 rounded-lg rounded text-gray-800 mb-6 leading-tight">Nandana Surgi Care</h1>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-blue-600 mx-auto mb-8"></div>
          <p className="text-lg sm:text-xl font-sans  text-black max-w-2xl mx-auto leading-relaxed">
            Trusted partner in world-class biomedical equipment distribution
          </p>
        </div>
        </div>

        <div className="relative inset-0 bg-gradient-to-r from-blue-50 via-white to-blue-50 px-10">
          {/* First Section */}
          {/* <motion.div
           ...
           <motion.p
            ...
            <div className="space-y-6 ">
              ...
              <h2 className="text-2xl lg:text-5xl font-bold text-gray-800 leading-tight">
                World-Class <span className="text-blue-600">Biomedical Equipment</span> Distribution
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                {['Cardiology', 'Thoracic Surgery', 'Neurosurgery', 'Plastic Surgery'].map((specialty) => (
                  <span key={specialty} className="text-sm sm:text-lg lg:text-2xl px-4 py-2 bg-blue-50 text-blue-900 rounded-lg font-bold">
                    {specialty}
                  </span>
                ))}
              </div>
           ...
           >
            <div className="relative ">
              ...
              <div className="relative bg-white p-2 rounded-2xl shadow-2xl">
                <div className="  bg-gradient-to-br from-blue-100 to-slate-100 rounded-xl flex items-center justify-center">
  ...
  <motion.div
           ...
           >
            ...
            >
                ...
                <h2 className="text-2xl lg:text-5xl font-bold text-gray-800 py-4 sm:py-0 leading-tight">
                  Strategic <span className="text-blue-600">Global Partnerships</span>
                </h2>
                </motion.p>
                    <motion.p
              //className="text-2xl text-black text-center leading-relaxed font-bold max-w-3xl mt-6 lg:mt-14"
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="group relative">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl blur opacity-0 group-hover:opacity-20 transition duration-500"></div>
        ...
        >
          {/* Animated Heading */}
          <motion.h2
            className="text-5xl text-center font-bold bg-gradient-to-r from-blue-700 to-blue-300 bg-clip-text text-transparent pb-7 pt-6 drop-shadow-lg"
