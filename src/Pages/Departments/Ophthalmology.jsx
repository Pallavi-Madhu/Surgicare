  ...
  import { ExternalLink, Globe, Package2, Building, ChevronRight, Star, ShoppingCart, ArrowLeftCircle,ArrowLeft, X } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    <div 
      className={`lg:hidden relative -translate-y-1/2 z-30 transition-all duration-300 ${
        isSidebarOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'
      }`}
    >
      <motion.div
