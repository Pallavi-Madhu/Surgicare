...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {!isScrolled && (
        <div className="absolute inset-0 z-[-2] bg-gradient-to-b from-blue-100 to-white transition-opacity duration-300" />
      )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-20 h-12 transition-colors duration-200 relative group bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
          ...
          <div className="hidden lg:flex space-x-8 items-center">
            ...
            <div className="relative">
              <button
                ...
                className="text-gray-700 hover:text-blue-600 font-semibold text-2xl transition-colors duration-200 relative group flex items-center space-x-1"
              >
                <span>Products</span>
              ...
              <AnimatePresence>
                {isProductsOpen && (
                  ...
                  >
                    <a
                      href="/products"
                      className="block px-6 py-3 text-blue-600 hover:shadow-lg hover:text-blue-900 font-semibold text-lg hover:bg-blue-50 transition-colors duration-200"
                    >
                      Equipments
                    </a>
                    <div>
                      <button
                        ...
                        className="w-full text-left px-6 py-3 text-blue-600 hover:shadow-lg hover:text-blue-900 font-semibold text-lg hover:bg-blue-50 transition-colors duration-200 flex items-center justify-between"
                      >
                            ...
                            <div className="grid grid-cols-2 gap-2 p-4">
                              {departments.map((dept) => (
                                <a
                                  key={dept.name}
                                  href={dept.href}
                                  className="text-gray-700 hover:text-blue-600 hover:bg-white px-3 py-2 rounded-lg transition-all duration-200 text-xl font-bold border border-transparent hover:border-blue-200"
                                >
                                  {dept.name} Products
                                </a>
                              ))}
