...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Show/hide navbar based on scroll direction, but don't hide if dropdowns are open
    ...
    <AnimatePresence>
      {isProductsOpen && (
        ...
        >
          <a
            href="/products"
            className="block px-6 py-3 text-green-600 hover:shadow-lg hover:text-green-900 font-semibold text-lg hover:bg-green-50 transition-colors duration-200"
          >
            Equipments
          </a>
          <div>
            <button
              ...
              className="w-full text-left px-6 py-3 text-green-600 hover:shadow-lg hover:text-green-900 font-semibold text-lg hover:bg-green-50 transition-colors duration-200 flex items-center justify-between"
            >
                  ...
                  <div className="grid grid-cols-2 gap-2 p-4">
                    {departments.map((dept) => (
                      <a
                        key={dept.name}
                        href={dept.href}
                        className="text-gray-700 hover:text-green-600 hover:bg-white px-3 py-2 rounded-lg transition-all duration-200 text-xl font-sans border border-transparent hover:border-green-200"
                      >
                        {dept.name} Products
                      </a>
                    ))}
